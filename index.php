   ...
   <div class="container-xxl py-5">
      <div class="text-center mx-auto mb-5 wow fadeIn" data-wow-delay="0.1s" style="max-width: 600px;">
         <div class="row mb-5">
            <div class="col-md-12">
               <div class="titlepage">
                  <h2 class="bawahtengah text-white">BPH Unibraw</h2>
               </div>
            </div>
         </div>
         <p class="text-center">
            Mewujudkan harmonisasi dan sinergisitas untuk
            mencapai demokrasi yang substantif dan
            berkeadilan
         </p>
      </div>
      <div class="row g-4 mb-3">
         ...
         <div class="col-md-3 col-xs-6 col-sm-6 col-6 wow fadeInUp" data-wow-delay="0.1s">
            <div class="position-relative rounded overflow-hidden">
               <div class="bigger">
                  ...
                  <div class="smaller">
                     <h3 class="text-center text-white">John Doe</h3>
                     <h4 class="text-center tekskuning">Jabatan</h4>
                  </div>
               </div>
            </div>
         </div>
